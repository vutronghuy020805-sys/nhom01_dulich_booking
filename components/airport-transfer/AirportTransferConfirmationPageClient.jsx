...
export default function AirportTransferConfirmationPageClient() {
  ...
  const totalPrice =
    parseInt(pick("totalPrice"), 10) ||
    (vehicle ? vehicle.price * carQuantity : 0);
  ...
  const leftFields = [
    {
      label: "Phương tiện",
      value: vehicle ? `${vehicle.name} (${vehicle.tier})` : "—",
    },
