...
import BusReviewClient from "@/components/bus/BusReviewClient";
import {
  findBusTripById,
  findBusLocationById,
...
export async function generateMetadata({ params }) {
  ...
  return {
    title: `Xem lại đặt chỗ vé xe khách ${tripId} | VieGo`,
  };
}

export default async function BusBookingReviewPage({ params, searchParams }) {
